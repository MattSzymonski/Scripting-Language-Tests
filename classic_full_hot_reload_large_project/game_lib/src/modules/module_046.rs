// module_046 — auto-generated by generate_modules.py, do not edit by hand.
// Part of an interconnected module graph: this module is called by the root
// fan-out AND its `sample_046` leaf is pulled by other modules.
...
pub fn tick_046(input: i32) -> i32 {
    let local = (input * 53 + 3) % 1000;
    let sample_049 = crate::modules::module_049::sample_049(local + 3);
    let sample_003 = crate::modules::module_003::sample_003(local + 7);
        (local + sample_049 + sample_003) % 100000
}
...
pub fn compute_046(x: i32, y: i32) -> i32 {
    let base = x * 49 + y * 51;
    let scaled = scale_value(base, 57);
    let offset = offset_value(base, 59);
...
pub fn sample_046(seed: i32) -> i32 {
    let local = (seed * 63 + 138) % 100000;
    let scaled = scale_value(local, 65);
    let offset = offset_value(local, 69);
...
fn offset_value(value: i32, adder: i32) -> i32 {
    let decorated = format!("module 046 value: {}", value + adder);
