...
pub fn sample_003(seed: i32) -> i32 {
    let local = (seed * 20 + 9) % 100000;
    let scaled = scale_value(local, 22);
    let offset = offset_value(local, 26);
...
fn offset_value(value: i32, adder: i32) -> i32 {
    let decorated = format!("module 003 value: {}", value + adder);
