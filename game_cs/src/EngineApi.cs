...
public unsafe struct EngineApi
{
    ...
    public delegate* unmanaged[Cdecl]<int, int> KeyDown;
    public delegate* unmanaged[Cdecl]<int, int> MousePressed;
    public delegate* unmanaged[Cdecl]<float> MouseX;
    public delegate* unmanaged[Cdecl]<float> MouseY;
